...
- Scheduled Delivery: [Schedule automated report](/reports/scheduling-reports) deliveries to your email or SFTP servers, ensuring you receive up-to-date information without manual effort. The report is only available after successful withdrawals.
...
| Other fields | Identical to the default fields in [Balance report](/reports/balance-report) |
