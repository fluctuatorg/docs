...
2. Retrieve the payment ID
   ...
   To retrieve the payment ID, follow how to [retrieve authorization data](/accept-payments/integration-guide/card-payments-via-api/retrieving-authorization-and-decline-details) for card payments.
