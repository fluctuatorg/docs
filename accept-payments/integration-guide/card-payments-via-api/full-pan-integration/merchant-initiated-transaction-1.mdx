...
>
> Xendit recommends to perform authentication (3DS2) when the shopper is present, to prevent potential [chargebacks](/accept-payments/fraud-risk/understanding-chargebacks#3d-secure-3ds-transactions).
>
...
Do take into account that cards from Canada, The United Kingdom and the United States sometimes do not support 3DS2, for these cards we suggest adding billing details to be verified by the [address verification service](/accept-payments/integration-guide/card-payments-via-api/cards-address-verification-service).
...
To retrieve the payment details (detailed error messages, codes and `network_transaction_id`) from the transaction, follow how to retrieve [authorization data](/accept-payments/integration-guide/card-payments-via-api/retrieving-authorization-and-decline-details) for card payments.
