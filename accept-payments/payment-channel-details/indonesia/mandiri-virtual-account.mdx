...
[null](https://cdn.document360.io/217abc43-8677-41fb-a81d-fceeb1fa0358/Images/Documentation/Mandiri%20Virtual%20Account.MP4)
...
<AccordionGroup>
  <Accordion title="What happens if I don't include verification data?">
    Payments to Mandiri virtual accounts will fail if verification data is missing after the feature goes live.
  </Accordion>
  ...
  <Accordion title="Do I need to implement this for all payment channels?">
    No, this requirement only applies to `MANDIRI_VIRTUAL_ACCOUNT` channels or any channel that required payer verification process.
  </Accordion>
