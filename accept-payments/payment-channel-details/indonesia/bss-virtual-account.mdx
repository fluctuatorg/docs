...
<AccordionGroup>
  <Accordion title="What happens if I don't include verification data?">
    Payments to BSS virtual accounts will fail if verification data is missing after the feature goes live.
  </Accordion>
  ...
  <Accordion title="Do I need to implement this for all payment channels?">
    No, this requirement only applies to `BSS_VIRTUAL_ACCOUNT` channels or any channel that required payer verification process.
  </Accordion>
