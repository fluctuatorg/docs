...
<AccordionGroup>
  <Accordion title="What is a Withholding Tax Slip (Bukti Potong PPh 23)?">
  ...
  <Accordion title="Why should I submit my Withholding Tax Slip?">
  ...
  <Accordion title="Who is eligible to make Withholding Tax deductions?">
  ...
  <Accordion title="What types of services are subject to Withholding Tax under Article 23?">
  ...
  <Accordion title="When is the right time to upload my Withholding Tax Slip?">
    You should upload your Withholding Tax Slip after making the payment for the invoice associated with the WHT.
  </Accordion>
  <Accordion title="What is the deadline for submitting the Withholding Tax Slip?">
  ...
  <Accordion title="What should I do if my submission keeps failing?">
  ...
  <Accordion title="Can I submit my Withholding Tax Slip through email or WhatsApp?">
  ...
  <Accordion title="I've previously submitted my Withholding Tax Slips through email. Should I re-upload them?">
  ...
  <Accordion title="Can I submit one Withholding Tax Slip for multiple invoices?">
  ...
  <Accordion title="Which value should be used as the basis for the 2% Withholding Tax under Article 23?">
    The Withholding Tax (PPh 23) is calculated at 2% of the Tax Base (DPP), which is the subtotal amount indicated on the invoice.
  </Accordion>
  <Accordion title="What tax code should I use to report PPh 23?">
  ...
  <Accordion title="What if the Tax Base on the Withholding Tax Slip differs from the subtotal on the invoice?">
  ...
  <Accordion title='We have made a payment with a 2% deduction for PPh 23, but our billing status still shows unpaid.'>
  ...
  <Accordion title='We have made a full payment, and our billing status shows "Paid". Do we still need to submit the Withholding Tax Slip?'>
  ...
  <Accordion title="What about the Withholding Tax Slip we have already reported for the invoice we have paid?">
    Please upload the Withholding Tax Slip on the platform. After validation, we will adjust your cash balance accordingly.
  </Accordion>
  <Accordion title="I haven't made the payment yet, but I have already issued the Withholding Tax Slip. I am unable to upload it on the Billing Statements page. What should I do?">
