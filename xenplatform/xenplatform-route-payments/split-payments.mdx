...
<AccordionGroup>
  <Accordion title="Why did my split payment fail even when the payment itself was successful?">
  ...
  <Accordion title="What happens to the split payment when the original payment is refunded?">
